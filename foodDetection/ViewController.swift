...
class ViewController: UIViewController {
    ...
    func show(predictions: [YOLO.Prediction]) {
        for i in 0..<boundingBoxes.count {
            if i < predictions.count {
                ...
                presentLabel = labels[prediction.classIndex]
    ...
    @IBAction func getFacts(_ sender: Any) {
        if presentLabel != "" {
           performSegue(withIdentifier: "label2", sender: self)
        }
    ...
    @IBAction func getFacts2(_ sender: RoundButton) {
        if presentLabel != "" {
        performSegue(withIdentifier: "label2", sender: self)
        }
    }
